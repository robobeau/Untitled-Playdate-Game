...
<tileset version="1.9" tiledversion="1.9.1" name="KimJumpNeutral" class="Animation" tilewidth="80" tileheight="128" tilecount="3" columns="0" objectalignment="bottom">
 <editorsettings>
 ...
 <tile id="2" class="Frame">
  ...
  <objectgroup draworder="index" id="2">
   ...
   <object id="2" name="Pushbox" class="Pushbox" x="2" y="44" width="72" height="84"/>
  </objectgroup>
 </tile>
 <tile id="3" class="Frame">
  ...
  <objectgroup draworder="index" id="2">
   <object id="1" name="Hurtbox" class="Hurtbox" x="20" y="22" width="40" height="76"/>
   <object id="2" name="Pushbox" class="Pushbox" x="2" y="44" width="72" height="84"/>
  </objectgroup>
 </tile>
</tileset>
