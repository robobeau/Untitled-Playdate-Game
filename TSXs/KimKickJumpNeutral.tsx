...
<tileset version="1.9" tiledversion="1.9.1" name="KimKickJumpNeutral" class="Animation" tilewidth="112" tileheight="128" tilecount="5" columns="0">
 ...
 <tile id="0" class="Frame">
  ...
  <image width="112" height="128" source="../source/images/Kim/KimKickJumpNeutral1.png"/>
 ...
 <tile id="3" class="Frame">
  ...
  <image width="112" height="128" source="../source/images/Kim/KimKickJumpNeutral4.png"/>
  <objectgroup draworder="index" id="2">
   <object id="1" name="Hurtbox" class="Hurtbox" x="36" y="44" width="40" height="74"/>
 ...
 <tile id="4" class="Frame">
  ...
  <image width="112" height="128" source="../source/images/Kim/KimKickJumpNeutral5.png"/>
  <objectgroup draworder="index" id="2">
