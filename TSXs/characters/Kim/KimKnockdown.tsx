...
<tileset version="1.10" tiledversion="1.10.2" name="KimKnockdown" class="Animation" tilewidth="112" tileheight="48" tilecount="1" columns="0">
 <editorsettings>
  <export target="../../../source/characters/Kim/animations/KimKnockdown.lua" format="lua"/>
 </editorsettings>
