...
<tileset version="1.10" tiledversion="1.10.2" name="KimBlockAirborne" class="Animation" tilewidth="64" tileheight="80" tilecount="1" columns="0">
 <editorsettings>
  <export target="../../../source/tsj/characters/Kim/KimBlockAirborne.lua" format="lua"/>
 </editorsettings>
